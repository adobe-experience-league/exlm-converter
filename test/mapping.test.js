...
describe('Mapping Tests', () => {
  describe('mapInbound using paths.yaml', () => {
    [
      ...
      [
        '/fragments/footer/master.html',
        '/content/experience-fragments/danaher/us/en/site/footer/master.html',
      ],
      [
        '/fragments/header/master.html',
        '/content/experience-fragments/danaher/us/en/site/header/master.html',
      ],
  ...
  describe('mapInbound', () => {
    [
      [
        '/vanity.html',
        '/content/site/us/en/page.html',
        ['/content/site/us/en/page:/vanity'],
      ],
      [
        '/vanity-bar.html',
        '/vanity-bar.html',
      ...
      [
        '/en-ch/index.html',
        '/content/site/ch/en.html',
        ['/content/site/us/en:/', '/content/site/ch/en:/en-ch/'],
      ],
  ...
  describe('mapOutbound using paths.yaml', () => {
    [
      ...
      [
        '/content/experience-fragments/danaher/us/en/site/footer/master.html',
        '/fragments/footer/master',
      ],
      [
        '/content/experience-fragments/danaher/us/en/site/header/master.html',
        '/fragments/header/master',
      ],
    ].forEach(([given, expected]) => {
      it(`maps ${given} to ${expected}`, () => {
  ...
  describe('mapOutbound', () => {
    [
      ...
      [
        ...
        '/en-us/page',
        ['/content/site/us/en/:/en-us/'],
      ],
      // special handling of /index
      [
        '/content/site/us/en/index',
        '/en-us/',
        ['/content/site/us/en/:/en-us/'],
      ],
      // folder to single page is ignored
